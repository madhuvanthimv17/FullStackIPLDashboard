...
public class BatchConfig {
    ...
    return new FlatFileItemReaderBuilder<MatchInput>()
        ...
        .delimited()
        .names(new String[]{"id","city","date","player_of_match","venue","neutral_venue","team1","team2","toss_winner","toss_decision","match_winner","result","result_margin","eliminator","method","umpire1","umpire2"})
